...
2. Create a project named "SmartAttendance" and create a cluster named "SmartAttendance-Cluster".
...
3. In tab "Media Library", create folder named "SmartAttendance".
4. Inside folder "SmartAttendance", create another two folders named "ProfilePicture" and "FaceGallery".
5. Click Setting icon on top right.
6. Under tab "Upload", scroll down until you see "Upload presets".
7. Click "Add upload preset", set Upload preset name to "SmartAttendance_facegallery" and folder set to "SmartAttendance/FaceGallery".
8. Leave the others as default and click "Save".
9. Again, click "Add upload preset", set Upload preset name to "SmartAttendance_profilepicture" and folder set to "SmartAttendance/ProfilePicture".
...
6. Add the javascript origin: http://localhost:3000, https://SmartAttendance.netlify.app
...
13. Add the javascript origin: http://localhost:4000, https://SmartAttendance.netlify.app
...
7. Go to GCP console, choose the "SmartAttendance" project.
...
10. Export the attendance excel sheet file of the history
